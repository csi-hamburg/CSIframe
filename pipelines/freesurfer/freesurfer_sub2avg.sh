...
[ -d $TMP_IN ] && cp -rf $DATA_DIR/freesurfer/$1 $DATA_DIR/freesurfer/fsaverage $ENV_DIR/standard/fsaverage5 $ENV_DIR/standard/fsaverage6 $TMP_IN 
...
CMD_THICK2FSAVG="
   ...
   --hemi {} \
   --sval $1/surf/{}.thickness \
   --tval $1/surf/{}.fsaverage.thickness.gii \
   --cortex
"
...
CMD_THICK2FSAVG5="
   ...
   --hemi {} \
   --sval $1/surf/{}.thickness \
   --tval $1/surf/{}.fsaverage5.thickness.gii \
   --cortex
"
...
CMD_THICK2FSAVG6="
   ...
   --hemi {} \
   --sval $1/surf/{}.thickness \
   --tval $1/surf/{}.fsaverage6.thickness.gii \
   --cortex
"
...
cp -ruvf $TMP_IN/$1 $DATA_DIR/freesurfer
