...
if [ $FBA_LEVEL == 1 ] || [ $FBA_LEVEL == all ];then
...
# Command
#########################
CMD_NII2MIF="mrconvert $DWI_PREPROC_UPSAMPLED_NII -fslgrad $DWI_PREPROC_UPSAMPLED_BVEC $DWI_PREPROC_UPSAMPLED_BVAL $DWI_PREPROC_UPSAMPLED_MIF"
CMD_DWI2RESPONSE="dwi2response dhollander $DWI_PREPROC_UPSAMPLED_MIF $RESPONSE_WM $RESPONSE_GM $RESPONSE_CSF"
...
# Command
#########################
CMD_RESPONSEMEAN_WM="responsemean -f $RESPONSE_WM_DIR/* $GROUP_RESPONSE_WM"
CMD_RESPONSEMEAN_GM="responsemean -f $RESPONSE_GM_DIR/* $GROUP_RESPONSE_GM"
CMD_RESPONSEMEAN_CSF="responsemean -f $RESPONSE_CSF_DIR/* $GROUP_RESPONSE_CSF"
