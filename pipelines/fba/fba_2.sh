...
# Command
#########################
CMD_DWI2FOD="ss3t_csd_beta1 -nthreads $SLURM_CPUS_PER_TASK -scratch $TMP_DIR $DWI_PREPROC_UPSAMPLED $GROUP_RESPONSE_WM $FOD_WM $GROUP_RESPONSE_GM $FOD_GM $GROUP_RESPONSE_CSF $FOD_CSF -mask $DWI_MASK_UPSAMPLED -force"
