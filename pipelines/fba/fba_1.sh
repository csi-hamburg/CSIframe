...
CMD_DWI2RESPONSE="dwi2response dhollander -nthreads 16 -scratch $TMP_DIR/{} $DWI_PREPROC_UPSAMPLED $RESPONSE_WM $RESPONSE_GM $RESPONSE_CSF -mask $DWI_MASK_UPSAMPLED -force"
