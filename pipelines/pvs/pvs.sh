...
( cp -ruvfL $ENV_DIR/freesurfer_license.txt $ENV_DIR/$container_freesurfer/opt/$container_freesurfer/.license )
...
WMMASK_T1=$DATA_DIR/wmh/$1/anat/ses-${SESSION}/${1}_ses-${SESSION}_space-T1_desc-wm_mask.nii.gz 
wmh_mask=$DATA_DIR/wmh/$1/anat/ses-${SESSION}/LOCATE/${1}_ses-${SESSION}_space-T1_desc-masked_desc-wmh_desc-LOCATE_mask.nii.gz
...
$singularity_antsrnet /bin/bash -c "$DENOISING"
## QIT
