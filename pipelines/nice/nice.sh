...
# [ $ORIG_SPACE == "FLAIR" ] && LESION_DIR_2=$DATA_DIR/$MODIFIER/$1/ses-2/anat
...
# #DSC_2_FLAIR2_ITK=$PERF_DIR/${1}_ses-${SESSION}_from-dsc_to-FLAIR_desc-affine.txt
...
# #CMD_DIL_CSF="maskfilter -npass 1 $CSF_DSC dilate $CSF_DSC_DIL -force"
# #CMD_ERO_BRAIN="maskfilter -npass 1 $DSC_BRAIN_MASK erode $DSC_BRAIN_MASK_ERO -force"
...
# #$singularity_mrtrix3 $CMD_DIL_CSF
# #$singularity_mrtrix3 $CMD_ERO_BRAIN
...
# CMD_TMAXRAPID2MNI="antsApplyTransforms -d 3 -e 0 -n Linear -i $TMAX_FLAIR -r $TEMPLATE -t $FLAIR2TEMPLATE_WARP -o $TMAX_TEMP"
...
if [ $TEMP_SPACE == "brainder" ];then
    ...
    for MOD in MTTz rBFz rBVz EFz Tmaxz; do
