...
def infotodict(seqinfo):
    ...
    for idx, s in enumerate(seqinfo):
        if ('ep2d_diff_tra_DTI_64no72_p2_monopolar_DFC' == s.series_description) or ('ep2d_diff_tra_DTI_64_p2_monopolar_DYNDIST_MIX' == s.series_description) or ('ep2d_diff_tra_DTI_72_p2_monopolar_DYNDIST' == s.series_description) :
