...
#SBATCH --nodes=1
#SBATCH --export=PIPELINE,PIPELINE_SUFFIX,SESSION,SUBJS_PER_NODE,ITER,ANALYSIS_LEVEL,OUTPUT_SPACES,HEURISTIC,RECON,OUTPUT_RESOLUTION,MRIQC_LEVEL,TBSS_PIPELINE,TBSS_MERGE_LIST,MODIFIER,ALGORITHM,DESIGN,BIASCORR,MASKINGGAME
